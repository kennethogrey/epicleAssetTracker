    ...
    <div class="py-12">
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="relative h-16 w-full ...">
                <div class="absolute top-0 right-16 h-16 w-16 ...">
                    <a href="{{ route('roles.create') }}" class="relative inline-flex items-center justify-center w-32 h-12 mb-2 overflow-hidden text-lg font-bold text-white bg-gray-500 group rounded-2xl">
                        Create Role
                    ...
                    <table class="w-full table-auto min-w-max">
                        <thead>
                            <tr class="text-sm leading-normal text-gray-600 uppercase bg-gray-200">
                                <th class="px-6 py-3 text-left">Role Number</th>
